"""expandir categorias para sede administrativa

Revision ID: a1b2c3d4e5f7
Revises: cc49122692e7
...
down_revision: Union[str, Sequence[str], None] = "cc49122692e7"
...
CATEGORY_CHECK_PREVIO = "category IN ('academico','administrativo','financiero','otro')"
